...
#from Book.views import homepage ,get_books,delete_book , update_book,soft_delete,active_book,in_active_books,restore_books
...
urlpatterns = [
    ...
    path('show-books/',views.get_books, name = "show"),
    path("delete-book/<int:id>/",views.delete_book, name = "delete"),
    path("soft-delete-book/<int:id>/",views.soft_delete, name = "soft-delete"),
    path("update-book/<int:id>/",views.update_book, name = "update"),
    path("active-book/",views.active_book, name = "active-books"),
    path("in_active-books/",views.in_active_books, name = "in_active-books"),
